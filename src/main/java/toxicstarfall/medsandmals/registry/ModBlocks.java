...
public class ModBlocks {
	...
	private static RegistryKey<Block> keyOfBlock(String name) {
		return RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MedsAndMals.MOD_ID, name));
	}
	
	private static RegistryKey<Item> keyOfItem(String name) {
		return RegistryKey.of(RegistryKeys.ITEM, Identifier.of(MedsAndMals.MOD_ID, name));
	}
	...
	public static final Block DIRT_COPY = register(
		"dirt_copy",
		Block::new,

...
import toxicstarfall.medsandmals.entity.BoneWitchEntity;
import toxicstarfall.medsandmals.entity.CubeEntity;
...
public class ModEntities {
	...
	public static final EntityType<CubeEntity> CUBE = Registry.register(
		...
		Identifier.of(MedsAndMals.MOD_ID, "cube"),
        EntityType.Builder.create(CubeEntity::new, SpawnGroup.CREATURE).dimensions(0.75f, 0.75f)
			.build(RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(MedsAndMals.MOD_ID, "cube")))
	);
	
			
	public static final EntityType<BoneWitchEntity> BONE_WITCH = Registry.register(
		Registries.ENTITY_TYPE,
		Identifier.of(MedsAndMals.MOD_ID, "bone_witch"),
		EntityType.Builder.create(BoneWitchEntity::new, SpawnGroup.MONSTER).dimensions(1.0f, 2.0f)
			.build(RegistryKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(MedsAndMals.MOD_ID, "bone_witch")))
	);

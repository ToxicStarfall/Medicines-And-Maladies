...
//		entity.addAttributeModifier(EntityAttributes.MOVEMENT_SPEED, "frozen", 0, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL);
	}
	...
	public boolean applyUpdateEffect(ServerWorld world, LivingEntity entity, int amplifier) {
		...
		// if (entity instanceof MobEntity) {
			// MedsAndMals.LOGGER.info("applyUpdateEffect for SedatedEffect");
			// entity.setMovementSpeed(0.0f);
			...
			// entity.addAttributeModifier(EntityAttributes.MOVEMENT_SPEED, "frozen", 0, EntityAttributeModifier.Operation.MULTIPLY_TOTAL);
